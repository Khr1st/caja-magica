...
REGLAS = [
    ...
    },
    {
        ...
        "tipo": "proyeccion",
        "categoria": "freelance",
        "mensaje": "Proyección de ingreso anotada. Actualiza cuando el pago llegue.",
    },
    {
        "nombre": "proyeccion_ventas_digitales",
        "pattern": r'voy a vender|espero vender|proyección.*venta|plantilla pendiente',
        "tipo": "proyeccion",
    ...
    },
    {
        ...
        "pattern": r'facturé|cobré|cliente pagó|consultoría|proyecto entregado|upwork|workana|servicio|honorarios',
        "tipo": "ingreso",
        "categoria": "freelance",
        "mensaje": "Ingreso de servicios registrado.",
    },
    {
        "nombre": "ingreso_ventas_digitales",
        "pattern": r'gumroad|plantilla|vendí|venta digital|producto digital|template|descarga',
        "tipo": "ingreso",
        "categoria": "ventas_digitales",
